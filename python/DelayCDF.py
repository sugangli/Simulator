...
kmed_delays = np.loadtxt("../delay_summary/kmed_all_delay_4.txt")
...
onpath_delays = np.loadtxt("../delay_summary/onpath_all_delay_4.txt")
...
random_delays = np.loadtxt("../delay_summary/random_all_delay_4.txt")
...
# And finally plot the cdf
plt.plot(random_bin_edges[0:-1], norm_random_cdf, label = "Random")

font_size = 20
tick_size = 15
plt.xlabel('Delay (s)', fontsize = font_size)
